...
class TestFileScannerService:
    ...
    async def create_test_file(
        self, file_path: str, content: str = "test content"
    ) -> None:
    ...
    async def test_cleanup_missing_files(
        self, file_scanner, state_manager, test_settings
    ):
    ...
    async def test_file_stability_check_promotion(
        self, file_scanner, state_manager, test_settings
    ):
    ...
    async def test_scanning_statistics(self, file_scanner, test_settings):
        ...
        expected_keys = {
            ...
            "file_stable_time_seconds",
            "growing_file_support_enabled",
            "growing_file_stats",
        }
        ...
        assert (
            stats["polling_interval_seconds"] == test_settings.polling_interval_seconds
        )
        assert (
            stats["file_stable_time_seconds"] == test_settings.file_stable_time_seconds
        )
