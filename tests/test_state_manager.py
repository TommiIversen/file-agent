...
class TestStateManager:
    ...
    async def test_add_existing_file_returns_existing(self, state_manager, sample_file_path):
    ...
    async def test_update_file_status_changes_status(self, state_manager, sample_file_path):
    ...
    async def test_update_nonexistent_file_returns_none(self, state_manager):
        ...
        result = await state_manager.update_file_status(
            "/nonexistent/file.mxf",
            FileStatus.READY
        )
        
        assert result is None
    
    async def test_remove_file_removes_from_tracking(self, state_manager, sample_file_path):
    ...
    async def test_thread_safety_concurrent_operations(self, state_manager):
        ...
        async def add_files():
            ...
            tasks = [
                state_manager.add_file(path, 1024) 
