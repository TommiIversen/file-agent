...
def test_file_organization():
    ...
    print(f"⚙️  Template System: {'Enabled' if settings.output_folder_template_enabled else 'Disabled'}")
    print()
...
def demonstrate_configuration_options():
    ...
    print('OUTPUT_FOLDER_RULES=pattern:*Cam*;folder:KAMERA\\{date},pattern:*PGM*;folder:PROGRAM_CLEAN\\{date}')
    print()
