...
class TestConfigurationInfo:
    ...
    def test_get_error_statistics_structure(self, error_handler):
        ...
        expected_keys = {
            "local_errors_count", "global_errors_count", "permanent_errors_count",
            "total_retries_performed", "in_global_error_state", "last_global_error_time",
    ...
    def test_get_classification_info(self, error_handler):
        ...
        expected_keys = {
            "permanent_patterns", "global_patterns", "local_patterns", "default_classification"
        }
