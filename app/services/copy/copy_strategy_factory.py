...
class CopyStrategyFactory:
    ...
    def should_use_temp_file(self, tracked_file: TrackedFile) -> bool:
        ...
        """
        return self._should_use_temp_file(tracked_file, self._is_growing_file(tracked_file))
    
    def get_progress_callback(self, tracked_file: TrackedFile) -> Callable[[CopyProgress], None]:
        """
    ...
    def _is_growing_file(self, tracked_file: TrackedFile) -> bool:
        ...
        return (
            getattr(tracked_file, 'is_growing_file', False) and
            self.settings.enable_growing_file_support
        )
    ...
    def _should_use_temp_file(self, tracked_file: TrackedFile, is_growing: bool) -> bool:
    ...
    def _get_optimal_chunk_size(self, tracked_file: TrackedFile, is_growing: bool) -> int:
    ...
    def _create_normal_file_callback(self, file_path: str, strategy_name: str) -> Callable[[CopyProgress], None]:
    ...
    def _create_growing_file_callback(self, file_path: str, strategy_name: str) -> Callable[[CopyProgress], None]:
