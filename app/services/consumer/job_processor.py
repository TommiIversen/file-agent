...
from app.services.consumer.job_models import ProcessResult, PreparedFile
        ...
        try:
            ...
            if self.space_manager.should_check_space():
                ...
                if not space_check.has_space:
                    return await self.space_manager.handle_space_shortage(job, space_check)
            
            # Step 2: Prepare file for copying
            prepared_file = await self.file_preparation_service.prepare_file_for_copy(job)
