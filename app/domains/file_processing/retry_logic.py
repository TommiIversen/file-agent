...
def should_give_up(current_retry_count: int, max_retries: int) -> tuple[bool, str]:
    """Should we give up retrying?"""
...
def should_retry_proceed(
    ...
    """Should a scheduled retry proceed?"""
...
def determine_recovery_status(
    ...
    """Determine status after network recovery."""
