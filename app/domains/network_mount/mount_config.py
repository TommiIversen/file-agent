...
class MountConfigHandler:
    ...
    def get_macos_mount_point(self) -> Optional[str]:
        """Get configured macOS mount point."""
        return getattr(self._settings, "macos_mount_point", None)

    def is_network_mount_configured(self) -> bool:
        """Check if network mounting is fully configured and enabled."""
        return self.is_auto_mount_enabled() and bool(self.get_network_share_url())
    ...
    def get_platform_config(self) -> dict:
        ...
        return {
            ...
            "macos_mount_point": self.get_macos_mount_point(),
        }
